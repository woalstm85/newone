 ...
 * @returns fetch 요청 옵션 객체
 */
const getDefaultOptions = (method: string = 'GET', includeAuth: boolean = true): RequestInit => {
...
class ApiClient {
   ...
   * @param endpoint - API 엔드포인트
   * @param file - 업로드할 파일
   * @param additionalData - 추가 데이터 (FormData에 포함)
   * @param options - 추가 옵션
   * @returns 응답 데이터
   */
